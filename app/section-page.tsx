                  ...
                  return (
                    <li className="chart-row chart-row-v2" key={item.id}>
                      <div className="chart-name chart-name-v2">
                        {candidate?.image_url ? <img src={candidate.image_url} alt="" width="38" height="38" /> : null}
                        <span>
                          {candidate ? <a href={`/candidats/${candidate.slug}`}>{candidate.display_name}</a> : "Profil indisponible"}
                        </span>
                      </div>
                      <div className="chart-track" aria-hidden="true">
                        <div className="chart-bar" style={{ width: `${Math.max(0, Math.min(100, score))}%` }} />
                      </div>
